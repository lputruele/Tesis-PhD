...
Process MEMORY\_FT \{\\[1ex]
\>w : BOOL; \\
\>r : BOOL;  \\
\>c0 : BOOL; // first bit \\
\>c1 : BOOL; // second bit \\
\>c2 : BOOL; // third bit \\[1ex]
...
\end{minipage}
\vspace{-0.5cm}
\caption{Procesos para el ejemplo de la celda de memoria.} \label{fig:exam_1_mem_cell}
\vspace{-0.5cm}
\end{figure}
...
La operación de lectura, por otro lado, retorna el valor que se repite al menos dos veces en los bits de memoria; esto se conoce como \emph{votación}. 
    La figura \ref{fig:exam_1_mem_cell} muestra los procesos representando el modelo nominal y el el modelo de la implementación tolerante a fallas en este ejemplo. 
...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.45]{Figs/architecture.eps}
    \vspace{-0.4cm}
...
2. \{ <> , \# , <m1r,m1c0,m1c2> , R \} \\ 
3. \{ <> , I\_m1.fail1 , <m1r,m1c0,m1c2> , V \} \\
4. \{ <> , \# , <m1c2> , R \} \\ 
5. \{ <> , I\_m1.fail3 , <m1c2> , V \} \\
6. \{ <> , \# , <> , R \} \\ 
...
Los experimentos fueron realizados en una MacBook Air con un procesador Intel Core i5 de 1.3 GHz y una memoria RAM de 4GB. La herramienta y los casos de estudio para reproducir los resultados se encuentran disponibles en un repositorio Zenodo \cite{MaskD}.

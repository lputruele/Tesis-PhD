...
Por otro lado, tambien hemos investigado propiedades de juegos estocásticos con funciones de payoff de recompensas totales bajo la asunción de que el minimizador (es decir, el entorno) emplea solo estrategias justas al jugar.  %We have proved that determinacy is preserved for stopping games when fairness is assumed. 
